...
// Задача 2: Напишіть функцію, яка обчислює суму чисел від 1 до заданого числа.
// Використовуйте цикл для послідовного додавання чисел.
...
// Задача 3: Напишіть функцію, яка перевіряє, чи є задане число простим
// (ділиться без остачі тільки на себе та на 1).
...
function isPositiveNumber(num) {
  ...
  // В іншому випадку, якщо num менше або дорівнює 0,
  // то num не є позитивним, тому повертаємо false
...
function isEmptyString(str) {
  ...
  // В іншому випадку, якщо str містить хоча б один символ,
  // то str не є порожнім рядком, тому повертаємо false
...
// Задача 6: Напишіть функцію checkDataType, яка приймає параметр value
// і перевіряє його тип даних.
// Функція повинна використовувати оператор typeof для визначення типу значення.
// Виведіть в консоль повідомлення з результатом перевірки типу,
// наприклад, Значення "hello" має тип "string"
...
function checkDataType(value) {
  ...
  if (typeof value === "number") return `Значення "42" має тип "number".`;
  else if (typeof value === "string")
    return `Значення "Hello" має тип "string".`;
  else if (typeof value === "boolean")
    return `Значення "true" має тип "boolean".`;
  else return `Значення "undefined" має тип "undefined".`;
}
...
// Задача 7: Напишіть функцію findMax, яка приймає два числа num1 і num2
// і повертає більше з них.
...
function findMax(num1, num2) {
  ...
  // В іншому випадку (якщо num2 більше або дорівнює num1),
  // то num2 є максимальним, тому повертаємо num2
...
// Задача 8: Напишіть функцію getUserStatus, яка приймає вік користувача age
//  і повертає рядок, що вказує на його статус.
// Якщо вік менше 18 років, функція повертає "Неповнолітній".
// Якщо вік від 18 до 65 років, функція повертає "Дорослий".
// Якщо вік більше або дорівнює 65 рокам, функція повертає "Пенсіонер".
// Використовуйте умовний оператор if, else if та оператори порівняння
// для визначення статусу користувача.
...
function getDayOfWeek(dayNumber) {
  ...
  // В кожному випадку (case) перевіряємо значення dayNumber
  // i присвоюємо змінній day відповідну назву дня тижня
...
// Задача 10: Напишіть функцію getVariableType, яка приймає змінну variable
// і повертає рядок, що відповідає типу цієї змінної.
...
function getVariableType(variable) {
  ...
  if (typeof variable === "number") return `Це число`;
  else if (typeof variable === "string") return `Це рядок`;
  else if (typeof variable === "boolean") return `Це булеве значення`;
...
// Задача 13: Задача: створити стрілкову функцію, яка приймає два числа
// і повертає їх добуток.
let multiply = (x, y) => {
...
// яка може бути викликана як `divide(x)(y)`,
...
// Створюємо змінну getDivider якій присвоємо результат
// виконання функції divide з аргументом 2
...
function memoizedArea(side) {
  ...
  // Якщо сторона відрізняється від попередньої, обчислюємо площу та
...
// Створюємо змінну createCompose якій присвоємо результат виконання
// функції compose з аргументами increment та double
